...
// Mobile Menu Toggle - Test Version with Alert
window.addEventListener('load', function() {
    ...
    if (toggle && menu) {
        toggle.onclick = function() {
            alert('Button clicked! Menu will toggle now.');
        ...
        // If elements not found, show error after 2 seconds
        setTimeout(function() {
            alert('Error: Menu elements not found. Toggle: ' + (toggle ? 'found' : 'NOT FOUND') + ', Menu: ' + (menu ? 'found' : 'NOT FOUND'));
        }, 2000);
    }
});
